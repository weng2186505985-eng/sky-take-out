...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderPaymentVO payment(OrdersPaymentDTO ordersPaymentDTO){
        ...
        orderPaymentVO.setPackageStr("模拟支付成功");
    ...
    public void paySuccess(String outTradeNo) {
        ...
        log.info("订单状态更新完成，订单ID：{}", ordersDB.getId());
    }
     ...
     * @param orders 订单信息
     */
    private void simulateRefund(Orders orders) {
        // 模拟退款处理
        log.info("=== 模拟退款操作 ===");
        log.info("订单号：{}", orders.getNumber());
        log.info("退款金额：{}", orders.getAmount());
        log.info("退款原因：商家拒单");
